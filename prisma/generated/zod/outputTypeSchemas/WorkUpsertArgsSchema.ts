...
import { WorkUpdateInputSchema } from '../inputTypeSchemas/WorkUpdateInputSchema'
import { WorkUncheckedUpdateInputSchema } from '../inputTypeSchemas/WorkUncheckedUpdateInputSchema'
...
export const WorkUpsertArgsSchema: z.ZodType<Prisma.WorkUpsertArgs> = z.object({
  select: WorkSelectSchema.optional(),
  include: WorkIncludeSchema.optional(),
  where: WorkWhereUniqueInputSchema,
  create: z.union([ WorkCreateInputSchema,WorkUncheckedCreateInputSchema ]),
  update: z.union([ WorkUpdateInputSchema,WorkUncheckedUpdateInputSchema ]),
}).strict() ;

export default WorkUpsertArgsSchema;
