...
export const HeroRelationCreateArgsSchema: z.ZodType<Prisma.HeroRelationCreateArgs> = z.object({
  select: HeroRelationSelectSchema.optional(),
  include: HeroRelationIncludeSchema.optional(),
  data: z.union([ HeroRelationCreateInputSchema,HeroRelationUncheckedCreateInputSchema ]),
}).strict() ;

export default HeroRelationCreateArgsSchema;
