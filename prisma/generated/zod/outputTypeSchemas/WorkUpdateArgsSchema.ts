...
export const WorkUpdateArgsSchema: z.ZodType<Prisma.WorkUpdateArgs> = z.object({
  select: WorkSelectSchema.optional(),
  include: WorkIncludeSchema.optional(),
  data: z.union([ WorkUpdateInputSchema,WorkUncheckedUpdateInputSchema ]),
  where: WorkWhereUniqueInputSchema,
}).strict() ;

export default WorkUpdateArgsSchema;
